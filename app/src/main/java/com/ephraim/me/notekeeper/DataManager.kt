package com.ephraim.me.takenotes.com.ephraim.me.notekeeper
...
object DataManager {
   ...
   private  fun initializeCourses() {
       ...
       course = CourseInfo(
           ...
           title = "Android Async ProgrammingServices"
       )
       courses.set(course.courseId, course)

       course = CourseInfo(
           title = "Java Fundamental: The Java Language",
           courseId = "java_lang"
       )
       courses.set(course.courseId, course)
       ...
       course = CourseInfo(
           "java_core",
           "Java Fundamental: The Core Platform"
       )
       courses.set(course.courseId, course)
